        ...
        <main className="flex-1">
          <section className="relative container mx-auto px-4 md:px-6 py-12 md:py-20 text-center overflow-hidden">
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
                ...
                <div className="mt-10 flex flex-col items-center justify-center">
                    <p className="font-semibold text-primary/90 text-lg md:text-xl backdrop-blur-sm p-2 rounded-lg">
                        <Headphones className="inline-block mr-2 h-5 w-5 md:h-6 md:w-6" />
          ...
          <section className="container mx-auto px-4 md:px-6 py-12">
             <div className="text-center mb-12 max-w-4xl mx-auto">
                <Badge variant="outline" className="text-base md:text-lg py-2 px-4 border-primary/50">
          ...
          <section id="game" className="container mx-auto px-4 md:px-6 py-12 md:py-20">
             <div className="text-center mb-12 max-w-4xl mx-auto">
                <Badge variant="outline" className="text-base md:text-lg py-2 px-4 border-accent/50">
          ...
          <section className="container mx-auto px-4 md:px-6 py-20 text-center">
            <div className="max-w-3xl mx-auto">
                <div className="space-y-4">
                    ...
                    <ul className="inline-grid grid-cols-1 sm:grid-cols-3 gap-x-8 gap-y-2 text-muted-foreground">
                 ...
                 <div className="mt-12 space-y-4 rounded-lg bg-card/20 p-6 md:p-8 border border-accent/20 backdrop-blur-sm max-w-xl mx-auto">
                    <div className='flex items-center justify-center gap-3'>
                      <Info className="h-6 w-6 text-accent" />
                      <h4 className="font-headline text-lg md:text-xl font-bold text-foreground">Pro-Tip: Genre Presets</h4>
                    </div>
